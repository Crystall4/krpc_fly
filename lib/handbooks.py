...
#0 главный диспетчер зоны, выдает информацию о диспетчерах и соседних зонах, ведет диспетчеризацию аварийных ситуаций, максимальный приоритет указаний
...
#11-100 аэропорты
TCZones_list={
 0:  {'i':0,  'name':'Global','typeTC':0,  'memo':'Глобальная зона хоста',    'mainTC':'SuperViser', 'Pzone':None},
 11: {'i':11, 'name':'KSC',   'typeTC':1,  'memo':'KSC - Kerbal Space Center','mainTC':'Main',       'Pzone':0},
 255:{'i':255,'name':'Test',  'typeTC':255,'memo':'Test zone',                'mainTC':'Test',       'Pzone':0}
}
