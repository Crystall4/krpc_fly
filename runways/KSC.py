...
vpp9	 = vpp_bearing(handbooks.VPP_list.get('KSC9').get('name'), handbooks.VPP_list.get('KSC9').get('edge1'), handbooks.VPP_list.get('KSC9').get('edge2'))
vpp27    = vpp_bearing(handbooks.VPP_list.get('KSC27').get('name'),handbooks.VPP_list.get('KSC27').get('edge1'),handbooks.VPP_list.get('KSC27').get('edge2'))
