...
vpp9	 = vpp_bearing(handbooks.VPP_sublist.get('KSC9').get('name'), handbooks.VPP_sublist.get('KSC9').get('edge1'), handbooks.VPP_sublist.get('KSC9').get('edge2'))
vpp27    = vpp_bearing(handbooks.VPP_sublist.get('KSC27').get('name'),handbooks.VPP_sublist.get('KSC27').get('edge1'),handbooks.VPP_sublist.get('KSC27').get('edge2'))

#======================================================================================================================	
#-------------------------------------name----------beg_deg,-end_deg,-STO,--SLA,---------centerZ,------subzones------------beg_det------------------end_det-------------main_route---------------------message------------------------------------------------------------------------------------
KSC_VPP =VPP('KSC_VPP',[vpp9,vpp27],[])
